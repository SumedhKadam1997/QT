...
Rectangle {
    ...
    Rectangle {
        ...
        height: parent.height
        anchors.left: student_all_books_rect.right
        color: "lightgreen"
            ...
            ColumnLayout {
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        } else if (db.checkBook("books", request_name_input_text.text)){
                            db.addPendingBook(request_name_input_text.text)
                            console.log("Book successfully requested")
                            allbooksmodel.updateModel(filter_textfield.text)
                            request_book_popup.close()
                        } else {
