				...
				namespace Imaging {
					class ASPOSE_CELLS_API BitmapData : public Object
					{
						private:
							...
							intrusive_ptr<IntegerPtr> Scan0;
							Int32 		reserved;

						public:
							BitmapData() : width(0), height(0), stride(0), pixel_format(PixelFormat_DontCare), reserved(0)
							{
								Scan0 = NEW IntegerPtr();
							}

							BitmapData(Int32 width, Int32 height, Int32 stride, Systems::Drawing::Imaging::PixelFormat pixel_format, intrusive_ptr<IntegerPtr> Scan0, Int32 reserved)
							{
								this->width = width;
								this->height = height;
								this->stride = stride;
							...
							intrusive_ptr<IntegerPtr> GetScan0() {
								return Scan0;
							}

							void SetScan0(intrusive_ptr<IntegerPtr> value) {
								Scan0 = value;
							}
