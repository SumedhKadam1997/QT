...
Rectangle {
    ...
    Rectangle {
        id: student_header_rect
        width: parent.width
        height: parent.height * 0.1
        color: "cyan"

        RowLayout {
            id: student_header_row
            anchors.fill: parent
            anchors.margins: 10
            ...
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        student_body_loader.setSource("qrc:/student/all_book_view.qml")
                    }
                }
            }
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        student_body_loader.setSource("qrc:/student/pending_book_view.qml")
                    }
                }
            }
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        student_body_loader.setSource("qrc:/student/issued_book_view.qml")
                    }
                }
            }
            Rectangle {
    ...
    Rectangle {
        id: student_body_rect
        width: parent.width
        height: parent.height * 0.9
        anchors.top: student_header_rect.bottom
        color: "skyblue"
