...
*/
//using namespace Gdiplus;
//#include "Aspose.Cells.Systems/Drawing/Status.h"
...
#else
				static void CheckStatus(GpStatus status)//linux:before is Status,which can be found in windows but not in linux
