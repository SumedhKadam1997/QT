	...
	namespace Cells {
		namespace Systems {
			namespace Drawing {
				...
				{
				private:
					intrusive_ptr<IntegerPtr> fontObject;
				...
				public:
					...
					FontPal(intrusive_ptr<IntegerPtr> newFontObject, StringPtr familyName, FontStyle style, Single size);
				...
				public:
					...
					static intrusive_ptr<FontPal> FromHfont(intrusive_ptr<IntegerPtr> hfont);
					intrusive_ptr<IntegerPtr> ToHfont();
