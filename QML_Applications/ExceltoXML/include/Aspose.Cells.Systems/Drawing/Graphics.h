...
#ifdef WIN32
#include "Aspose.Cells.Systems/Drawing/GdipFuns.h"//linux
...
namespace Drawing {
	...
	public:
		Graphics();
		Graphics(intrusive_ptr<IntegerPtr> gdipNativeGraphics);
		void InitVars();
		...
		static intrusive_ptr<Graphics> FromHdc(intrusive_ptr<IntegerPtr> hdc);
		...
		Single GetDpiX();
		Single GetDpiY();
		intrusive_ptr<IntegerPtr> GetHdc();
		void ReleaseHdc();
		void ReleaseHdc(intrusive_ptr<IntegerPtr>);
		...
		intrusive_ptr<Aspose::Cells::Systems::Drawing::SizeF> gMeasureString(intrusive_ptr<IntegerPtr> graphics, StringPtr text, intrusive_ptr<Aspose::Cells::Systems::Drawing::FontPal> font,
			intrusive_ptr<Aspose::Cells::Systems::Drawing::RectangleF> layoutRect, intrusive_ptr<IntegerPtr> stringFormat);
