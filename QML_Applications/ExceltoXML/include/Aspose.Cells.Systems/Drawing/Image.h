...
namespace Drawing {
	...
	public:
		...
		void Save(StreamPtr stream, intrusive_ptr<Aspose::Cells::Systems::Drawing::Imaging::ImageCodecInfo> encoder, intrusive_ptr<Aspose::Cells::Systems::Drawing::Imaging::EncoderParameters> encoderParams);
		...
		void SetNativeObject(intrusive_ptr<IntegerPtr> _value);
		static intrusive_ptr<IntegerPtr> InitFromStream(StreamPtr stream);
		ObjectPtr Clone();
		...
		static intrusive_ptr<Image> CreateFromHandle(intrusive_ptr<IntegerPtr> handle);
